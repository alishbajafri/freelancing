...
import { Wallet as WalletIcon, ArrowDownToLine, ArrowUpFromLine, Lock, Clock } from 'lucide-react-native';
      ...
      <View style={styles.balanceCard}>
        ...
        <View style={styles.balanceBreakdown}>
          ...
          <View style={styles.breakdownItem}>
            ...
            <Text style={[styles.breakdownAmount, styles.escrowAmount]}>
              ${WALLET_BALANCE.escrow.toFixed(2)}
            </Text>
          </View>
        </View>
          ...
          <View key={transaction.id} style={styles.transactionCard}>
            <View style={styles.transactionIcon}>
              ...
              {transaction.type === 'payment' && (
                <ArrowUpFromLine size={20} color="#EF4444" strokeWidth={2} />
              )}
              {transaction.type === 'deposit' && (
                <ArrowDownToLine size={20} color="#10B981" strokeWidth={2} />
              )}
            </View>
